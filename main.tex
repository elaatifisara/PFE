...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{diag_auth.png}
    \caption{Diagramme de séquence - Inscription et authentification}
    \label{fig:seq_auth}
    \end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{rech_fil_lieux_tour.png}
    \caption{Diagramme de séquence - Recherche et filtrage de lieux touristiques}
    \label{diagramme Recherche et filtrage de lieux touristiques}
    \end{figure}
\end{spacing}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{diagramme-reservation-transport.png}
...
Ce diagramme de séquence illustre les interactions entre l’utilisateur, l’interface, le serveur et les services externes lors du processus de réservation. Il montre les différentes étapes du traitement de la demande, depuis la saisie des informations jusqu’à la confirmation de l’opération.

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{diag_seq_ges_res.png}
    \caption{Diagramme de séquence - Gestion des réservations d'hebergements}
    \label{fig:diagram gestion des reservations}
    \end{figure}
