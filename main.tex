...
\begin{StdTable}[h]{Comparatif des plateformes touristiques existantes}{tab:comparatif_plateformes_unifie}{|X|X|X|X|X|X|X|X|}
\hline
Plateforme & Hébergement & Transport \newline aéroport & Lieux \newline touristiques & Avis \newline utilisateurs & Multilingue \newline FR/EN & Paiement \newline local Maroc & Transparence \newline prix \\
\hline
Google \newline Travel & Oui \newline (agrégation) & Non & Oui \newline (agrégation) & Oui & Partiel & Non & Variable \\
\hline
Booking.com & Très étendu & Partiel & Non & Très étendu & Oui & Non & Faible \\
\hline
Airbnb & Oui \newline (particuliers) & Non & Partiel & Oui & Oui & Non & Sans objet \\
\hline
Tripadvisor & Agrégation & Non & Oui & Très étendu & Oui & Non & Sans objet \\
\hline
Expedia & Très étendu & Partiel & Activités & Moyen & Oui & Non & Moyenne \\
\hline
GetYour \newline Guide & Absent & Non & Activités \newline seules & Oui & Oui & Non & Sans objet \\
\hline
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.50\textwidth]{di previ.jpeg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.50\textwidth]{di real.jpeg}
