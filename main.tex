...
\begin{StdTable}[h]{Comparatif des plateformes}{tab:comparatif_plateformes_1}{|X|X|X|X|X|X|}
...
\begin{StdTable}{Présentation des acteurs du système}{tab:acteurs}{|p{3.2cm}|X|X|}
\hline
\textbf{Acteur} & \textbf{Description} & \textbf{Principales interactions avec le système} \\ \hline
\textbf{Touriste \newline (Utilisateur)} & Voyageur national ou international souhaitant organiser son séjour au Maroc via la plateforme. & Recherche de lieux, réservation de transport, hébergement et activités, paiement, gestion du profil et publication d'avis. \\ \hline
\textbf{Prestataire de services} & Professionnel proposant des services touristiques (hébergement, transport, activités, restauration, excursions, etc.). & Publication et gestion des offres, mise à jour des disponibilités, gestion des réservations et interaction avec les avis clients. \\ \hline
\textbf{Administrateur} & Responsable de la gestion et du bon fonctionnement global de la plateforme. & Gestion des utilisateurs, validation des prestataires, supervision des contenus, modération des avis et suivi des paiements. \\ \hline
\end{StdTable}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{catalog copy.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{catalog detail.png}
\caption{Exemple d'activité à réserver}
\label{fig:Exemple d'activité à réserver}
\end{figure}
\begin{figure}[H]
...
\textbf{Cas de test}
\begin{StdTable}[H]{Tests Fonctionnels - Recherche de lieux touristiques}{tab:test_module_connexion}{|X|X|X|X|}
\hline
\textbf{ID} & \textbf{Action} & \textbf{Résultat attendu} & \textbf{Résultat obtenu} \\ \hline
